...
;
wasmImports.jsbody = {
	'_GraalTetris._clearRect___JSObject_I_I_I_I_V' : (...args) => (function(context,x,y,w,h){
		try{
			context.clearRect(x, y, w, h);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris._fillRect___JSObject_I_I_I_I_V' : (...args) => (function(context,x,y,w,h){
		try{
			context.fillRect(x, y, w, h);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris._setFillStyle___JSObject_String_V' : (...args) => (function(context,color){
		try{
			context.fillStyle = color;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.addEventListenerImpl___JSObject_String_GraalTetris$EventHandler_V' : (...args) => (function(o,event,handler){
		try{
			o.addEventListener(event, (e) => handler(e));
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.appendChild___JSObject_JSObject_V' : (...args) => (function(parent,child){
		try{
			parent.appendChild(child);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.clearInterval___I_V' : (...args) => (function(intervalId){
		try{
			clearInterval(intervalId);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.createElement___String_JSObject' : (...args) => (function(tag){
		try{
			return document.createElement(tag);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.document___JSObject' : (...args) => (function(){
		try{
			return document;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.exportTetris___Consumer_V' : (...args) => (function(r){
		try{
			window.graalTetris = r;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.fireGameStateEvent___JSObject_I_Z_V' : (...args) => (function(element,scrore,gameOver){
		try{
			element.dispatchEvent(new CustomEvent((gameOver ? 'game-over-event' : 'game-state-event'), {bubbles:true , detail:{'score': scrore, 'gameOver': gameOver}}));
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.get2dContextJso___JSObject_JSObject' : (...args) => (function(canvas){
		try{
			return canvas.getContext('2d');
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.getKeyCode___JSObject_I' : (...args) => (function(evt){
		try{
			return evt.keyCode;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.setAttribute___JSObject_String_Object_V' : (...args) => (function(elem,attribute,value){
		try{
			elem.setAttribute(attribute, value);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_GraalTetris.setInterval___Runnable_I_I' : (...args) => (function(r,ms){
		try{
			return setInterval(r, ms);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
